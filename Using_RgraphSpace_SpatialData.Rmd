...
```{r, eval=TRUE, message=FALSE}
colnames(flights_cf) <- c("sg_icao_origem","sg_icao_destino","weight")
...
h <- ggplot() +
  ...
  inject_nodespace() +
  labs(subtitle="Domestic flights in Southeast Region from Brazil in 2024",colour="Log10 (n°of flights)",
