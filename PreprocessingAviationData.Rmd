...
Now all data were loaded and filtered, so we will save them for RGraphSpace vignette:

```{r, eval=TRUE, message=FALSE, results='hide'}
save(mapa_brasil, se_states, flights_cf, active_airports, file = "sf_brazilflights_2025.RData")
